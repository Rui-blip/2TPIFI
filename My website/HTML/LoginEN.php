        ...
        <div id="signin">
            <form method="POST" class="myForm" name="myForm">
                ...
                <div class="input-container">
                    ...
                    <input type="password" placeholder="Password" name="passwordSignin" class="input-field" required>
                </div>
                <div><button type="submit" class="bttn red">Login</button></div>
                <br>
                <div><a style="color: inherit; text-decoration: none; color: white;" onclick="switchform('SignUp');" type="button" class="bttn grey">Create Account</a></div>
            </form>
        </div>
        ...
        <div id="signup" hidden>
            <form method="POST" class="myForm" name="myForm">
                <div class="input-container">
                    ...
                    <input type="text" placeholder="First Name" name="firstnameSignup" class="input-field" required>
                </div>
                <div class="input-container">
                    <i class="fa fa-user-circle icon"></i>
                    <input type="text" placeholder="Last Name" name="lastnameSignup" class="input-field" required>
                </div>
                <div class="input-container">
                    <i class="fa fa-envelope icon"></i>
                ...
                <div class="input-container">
                    <i class="fa fa-key icon"></i>
                    <input type="password" placeholder="Password" name="passwordSignup" class="input-field" required>
                </div>
                <div class="input-container">
                    <i class="fa fa-key icon"></i>
                    <input type="password" placeholder="Repeat Password" name="passwordRepeatSignup" class="input-field" required>
                </div>
                <div><button type="submit" class="bttn red">Sign up</button></div>
                <br>
                <div><a style="color: inherit; text-decoration: none; color: white;" onclick="switchform('SignIn');" type="button" class="bttn grey">Login with existant Account</a></div>
            </form>
        </div>
